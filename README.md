...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/YOLO-Object%20Detection-00FFFF?style=for-the-badge&logo=ultralytics&logoColor=black"/>
  <img src="https://img.shields.io/badge/scikit--learn-ML%20Model-F7931E?style=for-the-badge&logo=scikit-learn&logoColor=white"/>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/ASL%20Accuracy-94--96%25-brightgreen?style=flat-square"/>
  <img src="https://img.shields.io/badge/ISL%20Accuracy-92--95%25-brightgreen?style=flat-square"/>
  <img src="https://img.shields.io/badge/Latency-%3C50ms-blue?style=flat-square"/>
  <img src="https://img.shields.io/badge/IEEE-ICCUBEA%202026-red?style=flat-square"/>
...
| Field | Details |
|-------|---------|
| 🏫 **Institution** | Fr. Conceição Rodrigues Institute of Technology (FCRIT), Vashi |
| 📄 **Research Paper** | *SilentEcho: Real-Time Sign Language Recognition Using MediaPipe and Random Forest* |
| 📡 **Conference** | IEEE ICCUBEA 2026 |
| 🧠 **Core Contribution** | Hybrid AI pipeline combining MediaPipe landmark detection with Random Forest classification for real-time, low-latency sign language translation |
| 🎯 **Impact** | Provides an affordable, hardware-free assistive communication tool for the hearing-impaired community |
...
├── dataset/
│   └── gestures.csv        # Custom landmark dataset
├── static/
│   ├── css/                # Stylesheets
│   └── js/                 # Frontend scripts
├── templates/
